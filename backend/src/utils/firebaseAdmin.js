...
const serviceAccountKey = {
    ...
    // CRITICAL FIX: The private_key string in JSON must have escaped newlines (\n)
    // We remove the literal newlines and spaces you had in the raw key for clean JSON parsing.
...
if (!admin.apps.length) {
    ...
    // We use the entire serviceAccountKey object directly
    admin.initializeApp({
